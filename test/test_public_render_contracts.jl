...
@testset "Public render contracts" begin
    ...
    @testset "Public surface matrix returns live PhyloPlot handles" begin
        ...
        plot_handle = Makie.plot!(plot_axis, PhyloMakie.readnewick(render_case.newick); render_kwargs...)
        ...
        convenience_handle =
            phyloplot!(convenience_axis, PhyloMakie.readnewick(render_case.newick); render_kwargs...)
    ...
    @testset "Public updates preserve child identity and caller-owned networks" begin
        ...
        surface = Makie.plot(PhyloMakie.readnewick(render_case.newick); render_case.attribute_kwargs...)
        plot = surface.plot
        ...
        new_net = PhyloMakie.readnewick(FIXTURE_CORPUS.render_regression_cases.style_majortree.newick)
